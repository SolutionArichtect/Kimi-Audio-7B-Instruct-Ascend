...
if __name__ == "__main__":
    try:
        ...
        print("Set NPU device to 5")
    except Exception as e:
        print(f"Failed to set NPU device to 5: {e}")

    parser = argparse.ArgumentParser()
    parser.add_argument("--model_path", type=str, default="/workspace/model/Kimi-Audio-7B-Instruct")
